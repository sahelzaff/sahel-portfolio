...
const Education = () => {
  ...
  const setupAnimations = useCallback(({ reducedMotion }) => {
    runStaggerReveal({
      ...
      options: { y: 18, stagger: 0.08, duration: 0.6 },
      reducedMotion,
    });

    runStaggerReveal({
      trigger: sectionRef.current,
      targets: timelineRef.current?.querySelectorAll('.education-row'),
      options: { y: 24, x: 10, stagger: 0.14, duration: 0.7 },
      reducedMotion,
    });
  }, []);
  ...
  return (
    <div ref={sectionRef} className='h-auto w-full bg-[#efefef] py-20' id='education_main'>
      <h1 ref={headingRef} className='text-black font-outfit font-bold text-[45px] text-center leading-[1]' id='education_heading'>
      ...
      <div id='education_main2' ref={timelineRef}>
        <div className='education-row flex flex-row items-start justify-start max-w-screen-2xl mt-20 bg-[#efefef]'>
          ...
          <div className='relative ml-20 mt-6 flex-shrink-0' id='middle_main1'>
          ...
          <div className='ml-20 flex-1' id='right_full'>
            <div id='right_div'>
        ...
        <div className='education-row flex flex-row items-start justify-start max-w-screen-2xl -mt-10 bg-[#efefef]'>
          <div className='flex flex-col items-start'>
          ...
          <div className='relative ml-[5.5rem] mt-6 flex-shrink-0' id='middle_main2'>
        ...
        <div className='education-row flex flex-row items-start justify-start max-w-screen-2xl -mt-10 bg-[#efefef]'>
          ...
          <div className='relative ml-[10.5rem] mt-6 flex-shrink-0' id='middle_main3'>
            ...
            <div className='relative h-7 w-7 ml-[1px] -mt-10 rounded-full bg-[#f8d08d] left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2'></div>
          </div>
          <div className='ml-20 flex-1' id='right_full'>
            <div>
