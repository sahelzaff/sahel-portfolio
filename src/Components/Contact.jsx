...
const Contact = () => {
  ...
  const setupAnimations = useCallback(({ reducedMotion }) => {
    ...
    runStaggerReveal({
      trigger: sectionRef.current,
      targets: formRef.current?.querySelectorAll('.input-container, .contact-submit'),
      options: { y: 18, stagger: 0.08, duration: 0.55 },
      reducedMotion,
    });
  }, []);
    ...
    <div ref={sectionRef} className='h-auto'>
      <div>
        <div className='flex flex-row items-start justify-start bg-[#f8d08d] py-20 px-20' id='contact_main'>
          <div ref={leftRef} className='w-1/2 flex flex-col items-start justify-start' id='contact_div1'>
            <div className='flex flex-col items-start justify-start'>
              <h1 className='text-[#0d0d0d] font-outfit text-[45px] font-bold leading-[1] whitespace-nowrap' id='contact_heading'>
                Get in <span className='text-[#efefef]'>Touch</span>
              </h1>
              <div className='w-5/12 bg-[#0d0d0d] h-[4px] rounded-lg mt-1 ml-1'></div>
            </div>
            <p className='font-poppins text-[25px] text-gray-800 font-bold mt-10 pr-14' id='contact_subheading'>
              Hi there!
            </p>
            <p className='font-poppins text-[16px] text-gray-800 font-medium mt-5 pr-14' id='contact_para'>
            ...
            <p className='font-poppins text-[16px] text-gray-800 font-medium mt-8 pr-14' id='contact_para'>
            ...
            <div className='py-20 flex flex-row items-center gap-3' id='quote_main'>
              <div className='h-20 w-[8px] bg-white'></div>
              <p className='font-poppins text-[26px] text-black font-bold pr-14' id='contact_quote'>
                Let&apos;s turn your ideas into reality - reach out and let&apos;s get started!
              </p>
            </div>
          </div>

          <div ref={rightRef} className='w-1/2 flex flex-col' id='contact_div2'>
            <div className='bg-[#efefef] py-14 px-5 rounded-2xl shadow-2xl'>
              <h1 className='font-outfit font-bold text-[40px] text-black text-center'>
                Fill In The <span className='text-[#f8d08d]'>Details</span>
              </h1>

              <div>
                <form ref={formRef} onSubmit={handleSubmit}>
                  <div className='flex flex-row w-full' id='contact_names'>
                    <div className='input-container w-1/2' id='contact_name_input'>
                      <input
                        name='firstName'
                        placeholder='First Name'
                        className='input-field bg-white rounded-lg'
                        type='text'
                  ...
                  <div className='contact-submit pl-5 pt-5'>
